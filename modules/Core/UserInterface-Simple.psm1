# UserInterface-Simple.psm1 - Simplified user interface for Windows Terminal Setup
...
function Show-StepHeader {
    ...
    Write-Host ""
    Write-Host "================================================================================" -ForegroundColor Cyan
    Write-Host " STEP ${StepNumber}: $($StepTitle.ToUpper())" -ForegroundColor Cyan
    if ($StepDescription) {
        Write-Host " $StepDescription" -ForegroundColor White
    }
    Write-Host "================================================================================" -ForegroundColor Cyan
    Write-Host ""
}
...
function Show-InstallationSummary {
    ...
    Write-Host " $statusIcon $statusText" -ForegroundColor $headerColor
    Write-Host "================================================================================" -ForegroundColor $headerColor
    Write-Host ""
